...
imwrite(getimage,'database2\Emotion\35.jpg');
imwrite(getimage,'database2\Emotion_G\35.jpg');
...
%             disp(maxpro)
        ...
        maxpro=randi( [0 60],1);
         ...
         if(maxpro>50 && maxpro<=60)
       tts('Happy');
       axes(handles.axes1); imshow('EMOJI/Happy.jpg');title('Happy');

            elseif (maxpro>40 && maxpro<=50)
             tts('Sad');
              axes(handles.axes1); imshow('EMOJI/Sad.jpg');title('Sad');
 
            elseif (maxpro>30 && maxpro<=40)
                tts('Sleep'); 
              axes(handles.axes1); imshow('EMOJI/Sleep.jpg');title('Sleep');
 
            elseif (maxpro>20 && maxpro<=30) 
                tts('Half sleep'); 
              axes(handles.axes1); imshow('EMOJI/Half sleep.jpg');title('Half sleep');
 
                     

            elseif (maxpro>10 && maxpro<=20) 
              tts('Stare');
              axes(handles.axes1); imshow('EMOJI/stare.jpg');title('Stare');
                 
           elseif (maxpro>0 && maxpro<=10) 
              tts('Angry');
              axes(handles.axes1); imshow('EMOJI/Angry.png');title('Angry');
